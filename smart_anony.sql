...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Sep 12, 2023 at 03:13 AM
...
(8, 'Suresh', 'suresh@gmail.com', '', 'Debarawewa', '81dc9bdb52d04dc20036dbd8313ed055', 'User');
...
CREATE TABLE IF NOT EXISTS `fines` (
  ...
  `Cus_ID` int NOT NULL,
  `Pro_ID` int NOT NULL,
  `FineCreatedDate` varchar(12) NOT NULL,
...
INSERT INTO `fines` (`Order_ID`, `Cus_ID`, `Pro_ID`, `FineCreatedDate`, `Amount`, `State`) VALUES
(50002, 2, 4, '2023-08-28', '150', 'NotRecieved'),
(50002, 2, 10, '2023-08-28', '120', 'NotRecieved'),
(50002, 2, 12, '2023-08-28', '150', 'NotRecieved'),
(50003, 2, 4, '2023-09-01', '30', 'Recieved');
...
(50002, 4, '300', '2023-08-27', 'NotRecieved'),
(50002, 10, '300', '2023-08-27', 'NotRecieved'),
(50002, 12, '300', '2023-08-27', 'NotRecieved'),
(50003, 4, '300', '2023-08-31', 'NotRecieved'),
(50004, 6, '250', '2023-09-01', 'Ordered'),
(50004, 7, '300', '2023-09-01', 'Ordered'),
(50004, 8, '250', '2023-09-01', 'Ordered');
...
(6, ' Uncut Gems (2019)', 1, 1, '250', 'With his debts mounting and angry collectors closing in, a fast-talking New York City jeweler risks everything in hope of staying afloat and alive.<br><br>Directors: Benny Safdie, Josh Safdie | Stars: Adam Sandler, Julia Fox, Idina Menzel, Mesfin Lamengo', 'https://www.youtube.com/embed/vTfJp2Ts9X8', 'img_649027cdb93c14.99742401.jpg'),
(7, 'The Trial of the Chicago 7 (2020)', 2, 1, '300', 'The story of 7 people on trial stemming from various charges surrounding the uprising at the 1968 Democratic National Convention in Chicago, Illinois.Director: Aaron Sorkin | Stars: Eddie Redmayne, Alex Sharp, Sacha Baron Cohen, Jeremy Strong', 'https://www.youtube.com/embed/zpOULjyy-n8?rel=0', 'img_649027cdb93c14.99742402.jpg'),
(8, 'Rewind (III) (2019)', 1, 2, '250', 'Digging through the vast collection of his father', 'https://www.youtube.com/embed/zpOULjyy-n8?rel=0', 'img_649027cdb93c14.99742459.jpg'),
(9, 'Soul (2020)', 1, 1, '300', 'After landing the gig of a lifetime, a New York jazz pianist suddenly finds himself trapped in a strange land between Earth and the afterlife.Directors: Pete Docter, Kemp Powers | Stars: Jamie Foxx, Tina Fey, Graham Norton, Rachel House', 'https://www.youtube.com/embed/zpOULjyy-n8?rel=0', 'img_649027cdb93c14.99742403.jpg'),
...
--
ALTER TABLE `fines`
  ADD CONSTRAINT `fines_ibfk_1` FOREIGN KEY (`Order_ID`) REFERENCES `order_details` (`Order_ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fines_ibfk_2` FOREIGN KEY (`Pro_ID`) REFERENCES `product` (`Pro_ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fines_ibfk_3` FOREIGN KEY (`Cus_ID`) REFERENCES `customer` (`Cus_ID`) ON DELETE CASCADE ON UPDATE CASCADE;
