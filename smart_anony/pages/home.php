...
-->
                            <a href="#" onclick="ordermng();">
                                <li class="treeview ">

                                    <i class="fa fa-user"></i><span>Order Manage</span>
                                    <span class="pull-right-container">
                                        <i class="fa fa-angle-left pull-right"></i>
                                    </span>
                ...
                <div class="content-wrapper">
                    ...
                    <section class="content-header">
                        ...
                        <div class="header-title">
                            <h6 style="margin-top: 10px;font-size: 18px;">Admin Pannel</h6>
                        ...
                        <div class="navbar-custom-menu" style="margin-left:910px;margin-top:10px;font-size:18px;">
                            <ul class="top">
                                ...
                                <li class="pro2" style="margin-left:30px;"><a href="logout.php"><i class="fa fa-sign-out"></i>
                                        Logout</a></li>
                                    ...
                                    <div class="card mx-auto">
                                        <center><img class="card-img-top mx-auto" style="width:60%;border-radius:100px;"
                                            ...
                                            <div class="card-body">
                                                ...
                                                <a href="#" class=" " onclick="editProf()"><i class="fa fa-edit">&nbsp;</i>Edit
                                                    Profile</a>
                                            </div>
                                        </center>
                                    </div>
                                    ...
                                    <div class="jumbotron" style="width:100%;height:100%;">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <h4 class="card-title">Order Manage</h4>
                                                        <p class="card-text">This section for Manage all orders include current
                                                            state, Fines and more...
                                                        </p>
                                                        <a href="#" onclick="ordermng()">Go</a>
                                                    </div>
                                                </div>
                                            </div>
        ...
        <script>
            ...
            function ordermng() { document.getElementById('window').innerHTML = '<object type="text/html" data="../templates/order.php" ></object>'; }
