        ...
        <div class="row">
            <div class="row">
                ...
                <form action="#" method="post" id="frmSrch">
                    ...
                    <input type="submit" id="btns" value="Search" style="background-color: blue;height:65%;" disabled>
                </form>
            </div><br><br>
        </div>
        <div class="row">
            ...
            if (isset($_POST['searchText'])) {
                ...
                //print_r($content) ;
                if ($pos !== false) {
                   echo '<script>window.scrollTo(0, ' . $pos . ');</script>';
                } else {
                    echo "The word \"$searchText\" was not found.";
                }
            }
